...
class Ui_ModelBrowser(object):
    def setupUi(self, ModelBrowser):
        ...
        self.splitter.setGeometry(QtCore.QRect(91, 80, 828, 431))
        ...
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.tab_previewer)
        ...
        self.widget = QtWidgets.QWidget(self.splitter_preview)
        ...
        self.lbl_solution = QtWidgets.QLabel(self.widget)
        font = QtGui.QFont()
        font.setFamily("黑体")
        font.setPointSize(12)
        self.lbl_solution.setFont(font)
        self.lbl_solution.setObjectName("lbl_solution")
        self.horizontalLayout.addWidget(self.lbl_solution)
        self.txt_solution = QtWidgets.QLineEdit(self.widget)
        self.txt_solution.setReadOnly(True)
        self.txt_solution.setObjectName("txt_solution")
        self.horizontalLayout.addWidget(self.txt_solution)
        spacerItem2 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout.addItem(spacerItem2)
        self.verticalLayout_3.addLayout(self.horizontalLayout)
        self.mapPreviewer = QgsMapCanvas(self.widget)
        self.mapPreviewer.setObjectName("mapPreviewer")
        self.verticalLayout_3.addWidget(self.mapPreviewer)
        self.chart_webView = QtWebKitWidgets.QWebView(self.splitter_preview)
        self.chart_webView.setObjectName("chart_webView")
        self.horizontalLayout_2.addWidget(self.splitter_preview)
    ...
    def retranslateUi(self, ModelBrowser):
        ...
        self.lbl_model.setText(_translate("ModelBrowser", "模型名称:"))
        self.lbl_solution.setText(_translate("ModelBrowser", "优化方案名称:"))
